...
public class ONCSecureWebServer
{
	...
	private static final String ONC_SERVER_KEYSTORE = "/Certs/2022Certs/oncdms.p12";
//	private static final String ONC_SERVER_KEYSTORE = "/Certs/2021Certs/oncdms.p12";
...
//						params.setSSLParameters(sslParameters);
		...
		String[] contexts = {"/dbStatus", "/agents", "/getagent", "/getmeal", "/children", "/adults", 
							...
							"/profileunchanged", "/dashboard", "/giftcatalog", "/schools",
							};
		...
		String[] loginContexts = {"/welcome", "/logout", "/login", "/onchomepage", "/metrics",
								  "/timeout", "/lostcredentials", "/verifyidentity", "/authenticatecode"};
