	...
	public void handle(HttpExchange te) throws IOException 
    {
		...
		if(requestURI.equals("/sms-receive"))
		{
			...
			if(fam != null)
			{
				...
				if(confirmingBody && fam.getLanguage().equals("Spanish"))
